...
![Alt text](images/Handleiding/add_workflow.png)
...
![Alt text](images/Handleiding/TriggerNode.png)
...
![Alt text](images/Handleiding/CatNode.png)
...
![Alt text](images/Handleiding/APIkey.png)
...
![Alt text](images/Handleiding/ResourceChoice.png)
#### *Bij Yes*
...
![Alt text](images/Handleiding/YesQualities.png)
#### *Bij No*
...
![Alt text](images/Handleiding/NoQualities.png)
#### *Bij Random Cat Gifs* 
...
![Alt text](images/Handleiding/GIFS.png)
...
![Alt text](images/Tests/CatWorkFlow.png)
...
![Alt text](images/Tests/TelegramTriggerOutput.png)
...
![Alt text](images/Tests/CatGifTest/CatWithGIFOutput.png)
...
![Alt text](images/Tests/CatGifTest/CatWithGIFExecute.png)

![Alt text](images/Tests/CatGifTest/CatWithGIFTest.png)

![Alt text](images/Tests/CatGifTest/CatWithGIF.png)
...
![Alt text](images/Tests/CatPictureTest/CatWithPictureOutput.png)

![Alt text](images/Tests/CatPictureTest/CatWithPictureTest.png)

![Alt text](images/Tests/CatPictureTest/CatWithPicture.png)

Toppie het gaat de juiste route op.

## Cat Pictures met Description

![Alt text](images/Tests/CatDescriptionTest/CatWithDescriptionOutput.png)

![Alt text](images/Tests/CatDescriptionTest/CatWithDescriptionTest.png)

![Alt text](/images/Tests/CatDescriptionTest/CatWithDescription.png)
...
![Alt text](images/Logica/flowwchart.png)

![Alt text](images/Logica/BreedsArray.png)
...
![Alt text](images/Logica/RegexMatchGif.png)
